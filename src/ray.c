...
/*   Updated: 2025/11/25 16:30:48 by plichota         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_ray_step(t_window *win, t_ray *ray)
{
	...
	printf("Init Ray Step: step_x=%d step_y=%d side_step_x=%.3f side_step_y=%.3f\n",
		ray->step_x, ray->step_y, ray->side_step_x, ray->side_step_y);
}
